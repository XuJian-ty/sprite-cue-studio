...
- **Unity 同步**：绑定 Unity 项目，同步角色、敌人、地图数据，自动安装 Runtime 并创建或更新 Prefab。
...
在工具中选择包含 `Assets`、`Packages`、`ProjectSettings` 的 Unity 项目根目录。首次同步会安装 `Packages/com.frame-action.runtime`，随后可分别同步角色、敌人、地图数据。
